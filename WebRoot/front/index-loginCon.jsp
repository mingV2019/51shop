					...
					<div>
						...
						<div class="search_box">
							<div class="top-nav-search">
								<form method="post" action="<%=basePath%>goodsinfoservlet?action=search">
									<input type="text" name="searchword" size="38" style="border: 0px;" class="top-nav-search-input" placeholder="请输入需要搜索的商品信息" value="" /> 
