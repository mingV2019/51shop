...
<%
	...
	SubType subType = dao.getSubTypeById(subId);
	...
	<table width="1280" height="288" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			...
			<table width="100%" border="0" cellspacing="0">
				...
				<form action="<%=basePath%>goodsinfoservlet?action=editSubType" method="post" name="form1">
					<table width="94%" border="0" align="right" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
						<tr>
							<td height="50">小分类信息ID</td>
							<td height="50"><input type="text" id="subId" name="subId" value="<%=subType.getSubId()%>" readonly/></td>
						</tr>
						<tr>
							<td height="50">选择所属分类：</td>
							<td height="50">
								<select name="superInfo" name="superInfo">
						...
						<tr>
							<td height="50">小分类信息名称：</td>
							<td height="50"><input type="text" name="typeName" id="typeName" value="<%=subType.getTypeName()%>"></td>
						</tr>
						<tr>
