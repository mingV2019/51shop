	...
	<table width="1280" height="288" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			<td align="center" valign="top">
				...
				<form action="<%=basePath%>goodsinfoservlet?action=updateGoodsInfo" enctype="multipart/form-data" method="post" name="form1" id="form1">
					<table width="94%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolordark="#FFFFFF">
						...
						<tr>
							...
							<td width="31%" height="27" id="superType">&nbsp; 
								...
								<%List<SuperType> superTypes = dao.getSuperTypeAll();
									...
									<option value="goods_add.jsp?superId=<%=superType.getSuperId()%>" 
									<%=superType.getSuperId()==goods.getSubType().getSuperType().getSuperId()?"selected":""%>>
							...
							<td width="42%" height="27" id="subType">&nbsp; 
								...
								<%List<SubType> subTypes = dao.getSubTypeBySuperID(goods.getSubType().getSuperType().getSuperId());
						...
						<tr>
							...
							<td colspan="3">
								...
								<textarea name="introduce" cols="60" rows="5" class="textarea" id="introduce"><%=goods.getIntroduce()%></textarea>
							</td>
						</tr>
						<tr>
